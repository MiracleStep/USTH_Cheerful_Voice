			...
			success : function(data) {
				if (data.res==1){
					...
					$.each(data.data.list, function(index, msgItem) {
						...
						msg.find(".theme").text(msgItem.thename);
	...
	<div class="container">		
		...
		<div class="row msglist template">
			...
			<div class="col-sm-9 col-xs-11">
				<div class="col-sm-6 col-xs-6 title"><a class="tit" target="_blank">标题</a></div>
				<div class="col-sm-2 col-xs-6 author">作者</div>
				<div class="col-sm-2 col-xs-6 time">时间</div>
				<div class="col-sm-2 col-xs-6 theme">主题</div>
			</div>
		</div>
		<div class= "list">
		</div>
